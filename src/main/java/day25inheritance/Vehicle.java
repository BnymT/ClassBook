...
public class Vehicle {
  ...
  /*
    ...
    8) Inheritance da variable lari ve method lari class tan cagirmak icin this veya super kullanilir.
    this ayni class icindeki variable lari veya method lari cagirmak icin kullanilir
     */