...
public class Lambda01 {
    ...
    public static void printEvenElements2(List<Integer> nums) {
        nums.
                stream(). // Akis olusturma
                filter(t -> t % 2 == 0). // 2 ye bolunen degerleri almak icin filtreleme
                forEach(t -> System.out.print(t + " ")); // filtreden sonra kalan elemanlari yazdirma
    }
    ...
    public static void printSquareOfOddElements(List<Integer> nums) {
        nums.
                stream().
                filter(t -> t % 2 != 0).
                map(t -> t * t). // Variable in degerini degistirmek icin kullanilir
    ...
    public static void printCubeOfDistinctOddElements(List<Integer> nums) {
        nums.stream().
                distinct(). // Tekrarli elemanlari streamden cikarir.
                filter(t -> t % 2 != 0).
                map(t -> Math.pow(t, 3)).
                forEach(t -> System.out.print(t + " "));
    }
    ...
    public static void printSumOfSquaresOfDistinctEvenElements(List<Integer> nums) {
        Integer sum = nums.
                ...
                filter(t -> t % 2 == 0).
                map(t -> t * t).
                reduce(0, (t, u) -> t + u); // streamden tek bir sonuc elde etmek icin kullanilir
    ...
    public static void getMaxValue1(List<Integer> nums) {
        Integer max = nums
                .stream()
                .distinct()
                .reduce(Integer.MIN_VALUE, (t, u) -> t > u ? t : u); // t ye ilk deger Integer.MIN_VALUE verildi
    ...
    public static void getMaxValue2(List<Integer> nums) {
        Integer max = nums
                .stream()
                .distinct()
                .reduce(nums.get(0), (t, u) -> t > u ? t : u); // t ye ilk deger streamdeki 0. index verildi
        System.out.println(max);
    }
    ...
    public static void getMaxValue3(List<Integer> nums) {
        Integer max = nums
                ...
                .sorted()
                .reduce((t, u) -> u)
                .get(); // t ye ilk deger streamdeki herhangi bir deger verildi
        System.out.println(max);
    }
