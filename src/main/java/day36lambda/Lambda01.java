...
public class Lambda01 {
    ...
    public static void main(String[] args) {
        ...
        // 1) Tum "avarageScore" larin 91 den buyuk olup olmadigini kontrol ediniz
        ...
        // Bir tane bile sart saglanmaz ise sonuc false olur

        // 2) Kurs isimlerinden en az birinin "Turkish" kelimesini icerip icermedigini kontorl eden notu yaziniz
        ...
        // 3) Kurs donemleri icinde "Fall" donemin hic bulunmadigini kontrol eden kodu yaziniz
        ...
        // 4) Avarage score u en yuksek olan kursun ismini console a yazdiriniz

        String name1 =
                courseList
                        .stream()
                        .sorted(Comparator.comparing(Course::getAvarageScore).reversed()) // sorted kucukten buyuge dogru siralar
                        .findFirst()
                        .get()
                        .getCourseName();
        System.out.println(name1);

        // 5) Tum course object lerinin avarage score a gore kucukten buyuge diziniz ve ilk ikisi haric liste halinde yazdirimiz
        ...
        // 7) Kursta bulunan ogrenci sayilarina gore kucuge sirali bir sekilde listin icinde veren kodu yaziniz
